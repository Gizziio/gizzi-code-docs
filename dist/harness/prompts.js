 ...
 */
export function injectSystemPrompt(messages, hasTools = false) {
 ...
 */
export function injectProviderPrompt(messages, provider) {
 ...
 */
export function createSystemOnlyMessages(hasTools = false) {
